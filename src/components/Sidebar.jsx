                ...
                <aside>
                  <div className="sidebar left float-left">
                    ...
                    <ul>
                      ...
                      {/* <li> <Link to="/bills" data-target="#dashboard" className="collapsed pt-4 pb-4" > <i className="fa fa-shopping-basket"></i> <span className="nav-label"> Bills </span> <span className="fa fa-chevron-right pull-right"></span> </Link></li> */}
